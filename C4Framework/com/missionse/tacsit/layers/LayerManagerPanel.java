...
public class LayerManagerPanel extends JPanel
{
    ...
    public LayerManagerPanel(final WorldWindow wwd)
    {
        ...
        this.layerNamesPanel.setBackground(new Color(0, 0, 0, 65));
        ...
        dummyPanel.setBackground(new Color(0, 0, 0));
        ...
        TitledBorder titleBorder = new TitledBorder("Layers");
        titleBorder.setTitleColor(Color.WHITE);
 
        titlePanel.setBorder(
            new CompoundBorder(BorderFactory.createEmptyBorder(9, 9, 9, 9), titleBorder ));
